...
#define NUMERIC_STR_415      "%s %s :Cannot send message to channel (+R) - you need to be logged in"
...
#define NUMERIC_STR_477      ":%s 477 %s %s :Cannot join channel (+r) - you need to be logged in"
